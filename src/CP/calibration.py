...
def calibrate(
    ...
    if t_grid is not None:
        # Policy B (notes/decisions/2026-07-15-cdf-legality-and-interval-reporting-policy.md): score through the
        ...
        # object as interval extraction in src/CP/interval.py.
