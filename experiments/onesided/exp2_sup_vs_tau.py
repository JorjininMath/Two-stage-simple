...
Usage:
    python experiments/onesided/exp2_sup_vs_tau.py
    python experiments/onesided/exp2_sup_vs_tau.py --taus 0.5 0.7 0.9 0.95
    python experiments/onesided/exp2_sup_vs_tau.py --n_macro 20 --n_jobs 4
    python experiments/onesided/exp2_sup_vs_tau.py --no_run --plot --save my_fig.png
"""
