...
Usage:
    python experiments/onesided/plot_crps_vs_h.py
    python experiments/onesided/plot_crps_vs_h.py --ell_x 0.5 --lam 0.001 --n_macro 5
    python experiments/onesided/plot_crps_vs_h.py --h_values 0.01,0.05,0.1,0.2,0.5,1.0
"""
