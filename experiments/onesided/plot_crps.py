...
Output:
  - experiments/onesided/output/crps_perpoint.csv   per-point CRPS for all macroreps
  - experiments/onesided/output/crps_curve.png      CRPS(x) curve (median + IQR band)

Usage:
    python experiments/onesided/plot_crps.py
    python experiments/onesided/plot_crps.py --n_macro 5
    python experiments/onesided/plot_crps.py --n_macro 5 --n_jobs 4 --save experiments/onesided/output/crps_curve.png
"""
...
# Direct script execution needs the repository's src-layout packages.
