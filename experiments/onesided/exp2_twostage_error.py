...
Usage
-----
    python experiments/onesided/exp2_twostage_error.py --n_macro 20 --n_jobs 4
    python experiments/onesided/exp2_twostage_error.py --n_macro 1 --n_train 500
    python experiments/onesided/exp2_twostage_error.py --no_run --plot
    python experiments/onesided/exp2_twostage_error.py --no_run --plot --save experiments/onesided/output_twostage/fig.png
"""
