...
Usage:
    python experiments/onesided/plot_exp2.py
    python experiments/onesided/plot_exp2.py --plot_type boxplot
    python experiments/onesided/plot_exp2.py --method CKME --plot_type boxplot
    python experiments/onesided/plot_exp2.py --save experiments/onesided/output_scaling/exp2_comparison.png
    python experiments/onesided/plot_exp2.py --plot_type boxplot --save experiments/onesided/output_scaling/exp2_box.png
"""
