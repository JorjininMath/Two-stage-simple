...
Usage:
    python experiments/onesided/diag_ckme_scaling.py --mode worst_x
    python experiments/onesided/diag_ckme_scaling.py --mode boundary
    python experiments/onesided/diag_ckme_scaling.py --mode q95err
    python experiments/onesided/diag_ckme_scaling.py --mode all --save experiments/onesided/output_scaling/diag.png
"""
...
def load_perpoint(output_dir: str) -> pd.DataFrame:
    ...
    if not os.path.exists(pp_dir):
        raise FileNotFoundError(
            ...
            "Run: python experiments/onesided/run_ckme_scaling.py --save_perpoint"
        )
