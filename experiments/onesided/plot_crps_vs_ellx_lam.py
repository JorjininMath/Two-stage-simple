...
Usage:
    python experiments/onesided/plot_crps_vs_ellx_lam.py
    python experiments/onesided/plot_crps_vs_ellx_lam.py --h 0.1 --n_macro 3
    python experiments/onesided/plot_crps_vs_ellx_lam.py --n_ellx 8 --n_lam 8
"""
