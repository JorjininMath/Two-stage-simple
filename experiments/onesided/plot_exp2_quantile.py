...
Params are loaded from experiments/onesided/pretrained_params.json (key "exp2").
...
Usage:
    python experiments/onesided/plot_exp2_quantile.py
    python experiments/onesided/plot_exp2_quantile.py --x 1.0 3.14159 5.5
    python experiments/onesided/plot_exp2_quantile.py --n_train 500 --r_train 15 --seed 7
    python experiments/onesided/plot_exp2_quantile.py --save experiments/onesided/output/exp2_quantile.png
"""
...
def make_figure(
    ...
    # Load params
    param_path = _EXPERIMENT_DIR / "pretrained_params.json"
    if not param_path.exists():
        raise FileNotFoundError(
            f"pretrained_params.json not found at {param_path}.\n"
            "Run: python experiments/onesided/pretrain_params.py --sims exp2"
        )
