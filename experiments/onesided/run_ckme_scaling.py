...
Usage:
    python experiments/onesided/run_ckme_scaling.py
    python experiments/onesided/run_ckme_scaling.py --n_macro 20 --n_jobs 4
    python experiments/onesided/run_ckme_scaling.py --monotone --n_macro 10
"""
...
def _load_pretrained() -> dict:
    ...
    print(
        ...
        "Run 'python experiments/onesided/pretrain_params.py --sims nongauss_A1S,nongauss_A1L' first.",
        file=sys.stderr,
    )
    return {}
