...
Usage:
    python experiments/onesided/plot_onesided.py
    python experiments/onesided/plot_onesided.py --mode coverage
    python experiments/onesided/plot_onesided.py --mode sup_error
    python experiments/onesided/plot_onesided.py --mode tailprob --macrorep 0
    python experiments/onesided/plot_onesided.py --macrorep 0 --save experiments/onesided/output/bounds.png
"""
