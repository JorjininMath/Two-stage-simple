...
Usage:
    python experiments/onesided/run_onesided_compare.py
    python experiments/onesided/run_onesided_compare.py --n_macro 5 --base_seed 0
"""
...
def _load_pretrained() -> dict:
    ...
    print(
        ...
        "Run 'python experiments/onesided/pretrain_params.py' first to improve accuracy.",
        file=sys.stderr,
    )
    return {}
