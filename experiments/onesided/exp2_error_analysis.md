...
In `experiments/onesided`, there is no Stage 2 — it is a one-shot uniform
...
Output CSV:
`experiments/onesided/output_sup_tau/sup_vs_tau_raw_step.csv`

![Sup error vs
tau](output_sup_tau/sup_vs_tau.png)
