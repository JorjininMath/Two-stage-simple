...
Usage:
    # Run experiment only
    python experiments/onesided/exp2_quantile_error.py --n_macro 10

    # Run then immediately plot boxplot
    python experiments/onesided/exp2_quantile_error.py --n_macro 10 --plot

    # Plot from existing CSV (no re-run)
    python experiments/onesided/exp2_quantile_error.py --no_run --plot

    # Save figure
    python experiments/onesided/exp2_quantile_error.py --no_run --plot --save experiments/onesided/output_exp2/exp2_box.png

    # Parallel macroreps
    python experiments/onesided/exp2_quantile_error.py --n_macro 20 --n_jobs 4 --plot
"""
