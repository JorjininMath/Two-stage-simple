...
Usage:
    python experiments/onesided/plot_exp1.py
    python experiments/onesided/plot_exp1.py --save experiments/onesided/output_scaling/exp1_comparison.png
    python experiments/onesided/plot_exp1.py --input experiments/onesided/output_scaling/scaling_summary.csv
"""
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        help="Output path for PNG (e.g. experiments/onesided/output_scaling/exp1_comparison.png). "
