...
Usage:
    python experiments/onesided/plot_ckme_scaling.py
    python experiments/onesided/plot_ckme_scaling.py --save_dir experiments/onesided/output_scaling/
    python experiments/onesided/plot_ckme_scaling.py --method CKME
    python experiments/onesided/plot_ckme_scaling.py --method QR --save_dir experiments/onesided/output_scaling/
    python experiments/onesided/plot_ckme_scaling.py --plot_type boxplot --save_dir experiments/onesided/output_scaling/
    python experiments/onesided/plot_ckme_scaling.py --plot_type boxplot --method CKME --save_dir experiments/onesided/output_scaling/
"""
