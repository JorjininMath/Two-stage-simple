...
Best params are saved to experiments/onesided/pretrained_params.json and loaded
automatically by run_onesided_compare.py.

Usage (from project root):
    python experiments/onesided/pretrain_params.py
    python experiments/onesided/pretrain_params.py --n_pilot 200 --r_pilot 5 --cv_folds 5
    python experiments/onesided/pretrain_params.py --sims exp2,nongauss_B2L
"""
...
def main():
    parser = argparse.ArgumentParser(
        description="Pre-train CKME hyperparameters for experiments/onesided via CV"
    )
    ...
    parser.add_argument("--output",      type=str, default=None,
                        help="Output JSON path (default: experiments/onesided/pretrained_params.json)")
    ...
    out_path = (
        ...
        else _EXPERIMENT_DIR / "pretrained_params.json"
    )
