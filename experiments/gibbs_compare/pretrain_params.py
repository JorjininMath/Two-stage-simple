...
for the Gibbs DGPs.  Results saved to experiments/gibbs_compare/pretrained_params.json.

Usage (from project root):
    python experiments/gibbs_compare/pretrain_params.py
    python experiments/gibbs_compare/pretrain_params.py --n_pilot 120 --r_pilot 8
"""
