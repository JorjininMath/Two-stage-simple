...
#
# Test run (1 task):
#   sbatch --array=0-0 experiments/gibbs_compare/run_all_gibbs_arc.sh
#
# Full run (50 tasks):
...
#SBATCH -t 02:00:00
#SBATCH --array=0-49
#SBATCH -o experiments/gibbs_compare/slurm_logs/slurm-%x-%A_%a.out
#SBATCH -e experiments/gibbs_compare/slurm_logs/slurm-%x-%A_%a.err
...
C_SCALE="2.0"
OUTPUT_DIR="experiments/gibbs_compare/output_adaptive_c${C_SCALE}"
BASE_SEED=42
