...
Usage (from project root):
  python experiments/gibbs_compare/plot_gibbs_compare.py
  python experiments/gibbs_compare/plot_gibbs_compare.py --output_dir experiments/gibbs_compare/output
"""
...
def _load_reference_data(out_dir: Path | None = None) -> dict:
    ...
    search_dir = out_dir if out_dir is not None else _EXPERIMENT_DIR / "output"
    gibbs_configs = [
