...
Usage (from project root):
  python experiments/gibbs_compare/run_gibbs_compare.py
  python experiments/gibbs_compare/run_gibbs_compare.py --n_macro 20 --n_workers 4
"""
...
CONFIG_PATH = _EXPERIMENT_DIR / "config.txt"
...
def main():
    ...
    if args.h_mode == "adaptive" and args.output_dir is None:
        ...
        out_dir = Path(args.output_dir) if args.output_dir else _EXPERIMENT_DIR / "output"
