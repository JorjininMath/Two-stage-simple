...
Usage:
    python experiments/gibbs_compare/run_gibbs_source.py
    python experiments/gibbs_compare/run_gibbs_source.py --n_rep 50 --output_dir experiments/gibbs_compare/output
"""
