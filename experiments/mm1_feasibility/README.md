...
```bash
python3 -m experiments.mm1_feasibility.experiment.run_kme_feasibility \
    --dgp exp_mm1 \
    --n-fit 1500 \
    --n-val 500 \
    --n-test 1000 \
...
Equivalently, from inside `experiments/mm1_feasibility/`, use:
...
- `experiments/mm1_feasibility/results/<prefix>_metrics.csv`
- `experiments/mm1_feasibility/results/<prefix>_test_predictions.csv`
- `experiments/mm1_feasibility/results/<prefix>_hyperparams.csv`
- `experiments/mm1_feasibility/results/<prefix>_config.json`
...
```bash
python3 -m experiments.mm1_feasibility.experiment.summarize_kme_feasibility \
    --input "experiments/mm1_feasibility/results/*_metrics.csv" \
    --out experiments/mm1_feasibility/results/kme_feas_summary.csv
```

Plot metrics and example CDF curves:

```bash
python3 -m experiments.mm1_feasibility.experiment.plot_kme_feasibility \
    --metrics experiments/mm1_feasibility/results/smoke_kme_feas_metrics.csv \
    --predictions experiments/mm1_feasibility/results/smoke_kme_feas_test_predictions.csv \
    --out-dir experiments/mm1_feasibility/figures \
    --log-dir experiment_logs/mm1_feasibility
```
...
```bash
python3 -m experiments.mm1_feasibility.experiment.plot_cdf_bands \
    --seed 20260604 \
    --n-train 800 \
    --rff-dim 80 \
    --n-bootstrap 200 \
