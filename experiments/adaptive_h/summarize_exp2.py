...
Decision rule (historical working plan):
...
Writes:
    experiments/adaptive_h/output_exp2/exp2_table.csv
    experiments/adaptive_h/output_exp2/exp2_table.tex   (booktabs LaTeX)

Usage (from project root):
    python experiments/adaptive_h/summarize_exp2.py
    python experiments/adaptive_h/summarize_exp2.py --n_bins 20 --alpha 0.1
"""
...
def main():
    ...
    if not delta_df.empty:
        ...
        print(
            f"\nHistorical decision rule: oracle should beat fixed on >=3 of {n_total} DGPs.\n"
