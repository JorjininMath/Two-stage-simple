...
Writes:
    experiments/adaptive_h/output_exp1/exp1_coverage_curves.png

Usage (from project root):
    python experiments/adaptive_h/plot_exp1.py
    python experiments/adaptive_h/plot_exp1.py --output_dir experiments/adaptive_h/output_exp1 --n_bins 25
"""
