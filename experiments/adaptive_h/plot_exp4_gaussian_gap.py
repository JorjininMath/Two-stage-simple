...
Writes:
    experiments/adaptive_h/output_exp4/exp4a_cov_gap_vs_budget.png

Usage (from project root):
    python experiments/adaptive_h/plot_exp4_gaussian_gap.py
    python experiments/adaptive_h/plot_exp4_gaussian_gap.py --output_dir experiments/adaptive_h/output_exp4
"""
