...
Goal from the historical working plan: show a plateau, not a knife-edge optimum, in conditional
...
Reads:
    experiments/adaptive_h/output_exp3/macrorep_{k}/case_nongauss_A1L_{arm}/per_point.csv

Writes:
    experiments/adaptive_h/output_exp3/exp3_table.csv
    experiments/adaptive_h/output_exp3/exp3_table.tex

Usage (from project root):
    python experiments/adaptive_h/summarize_exp3.py
    python experiments/adaptive_h/summarize_exp3.py --n_bins 20 --alpha 0.1
"""
...
def main():
    ...
    parser.add_argument("--output_dir", type=str, default="experiments/adaptive_h/output_exp3")
