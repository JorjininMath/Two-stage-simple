"""
experiments/adaptive_h / Exp2: fixed h vs oracle h(x) = c * s(x).
...
Outputs:
    experiments/adaptive_h/output_exp2/
        macrorep_{k}/case_{sim}_fixed/per_point.csv
        macrorep_{k}/case_{sim}_oracle/per_point.csv

Usage (from project root):
    python experiments/adaptive_h/run_exp2_oracle.py
    python experiments/adaptive_h/run_exp2_oracle.py --n_macro 50 --n_workers 6
    python experiments/adaptive_h/run_exp2_oracle.py --c_scale 0.5
"""
...
def main():
    ...
    out_dir = Path(args.output_dir) if args.output_dir else _root / "experiments" / "adaptive_h" / "output_exp2"
