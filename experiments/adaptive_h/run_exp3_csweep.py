"""
experiments/adaptive_h / Exp3: c sensitivity on nongauss_A1L.
...
Usage (from project root):
    python experiments/adaptive_h/run_exp3_csweep.py --n_macro 50 --n_workers 6
    python experiments/adaptive_h/run_exp3_csweep.py --c_list 0.3,0.5,1.0,2.0
"""
...
def main():
    ...
    out_dir = Path(args.output_dir) if args.output_dir else _root / "experiments" / "adaptive_h" / "output_exp3"
