...
Writes:
    experiments/adaptive_h/output_exp3/exp3_coverage_curves.png
    experiments/adaptive_h/output_exp3/exp3_metric_vs_c.png

Usage (from project root):
    python experiments/adaptive_h/plot_exp3.py
    python experiments/adaptive_h/plot_exp3.py --output_dir experiments/adaptive_h/output_exp3 --n_bins 25
"""
