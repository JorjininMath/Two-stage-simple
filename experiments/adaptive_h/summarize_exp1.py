...
Reads:
    experiments/adaptive_h/output_exp1/macrorep_{k}/case_{sim}/per_point.csv

Writes:
    experiments/adaptive_h/output_exp1/exp1_table.csv
    experiments/adaptive_h/output_exp1/exp1_table.tex   (booktabs LaTeX)

Usage (from project root):
    python experiments/adaptive_h/summarize_exp1.py
    python experiments/adaptive_h/summarize_exp1.py --n_bins 20 --alpha 0.1
"""
...
def main():
    ...
    parser.add_argument("--output_dir", type=str, default="experiments/adaptive_h/output_exp1")
