...
Plot conditional noise std sigma(x) for the adaptive-bandwidth experiments:
...
Output: experiments/adaptive_h/noise_functions.png
"""
...
# Keep this direct plotting entrypoint independent of editable installation.
