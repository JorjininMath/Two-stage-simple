"""
experiments/design: Stage design experiments for CKME-DCP.
...
Usage (from project root):
  ...
  python experiments/design/run_design_compare.py --exp A --dgp exp2_gauss_low --n_macro 5

  # Exp B: S^0 vs LHS
  python experiments/design/run_design_compare.py --exp B --dgp exp2_gauss_high --n_macro 20

  # Exp C: B1/B2 ratio
  python experiments/design/run_design_compare.py --exp C --dgp exp2_gauss_low --n_macro 20
"""
...
def _make_a1_raw(nu: float) -> dict:
    ...
    Local to experiments/design only; does not affect experiments/nongauss results.
    """
