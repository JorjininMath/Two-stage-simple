# experiments/design: Ablation Report
...
DGPs (from `examples/exp2_gauss.py` + `src/Two_stage/sim_functions/exp1`):
...
(`experiments/design/pretrained_params.json`). Evaluation on `n_test = 1000` LHS
...
- **Main figure**: Δ IS vs B_total, 3 DGP × 2 noise = 6 curves (or 2×3
  subplot). Runner: `experiments/design/run_saturation_sweep.py`.
...
`experiments/design/calibrate_fill_factor.py` should sweep `n_0` for `d in {1, 5}`,
...
```bash
# Exp A
python experiments/design/run_design_compare.py --exp A --dgp exp1            --n_macro 5 --output_dir experiments/design/output/expA_s1small/exp1
python experiments/design/run_design_compare.py --exp A --dgp exp2_gauss_low  --n_macro 5 --output_dir experiments/design/output/expA_s1small/exp2_gauss_low
python experiments/design/run_design_compare.py --exp A --dgp exp2_gauss_high --n_macro 5 --output_dir experiments/design/output/expA_s1small/exp2_gauss_high

# Exp B (4-way S^0 ablation)
python experiments/design/run_design_compare.py --exp B --dgp exp1            --n_macro 5 --output_dir experiments/design/output/expB_var_epi/exp1
python experiments/design/run_design_compare.py --exp B --dgp exp2_gauss_low  --n_macro 5 --output_dir experiments/design/output/expB_var_epi/exp2_gauss_low
python experiments/design/run_design_compare.py --exp B --dgp exp2_gauss_high --n_macro 5 --output_dir experiments/design/output/expB_var_epi/exp2_gauss_high

# Exp C (B_total=5000, r_0=10 r_1=5)
for dgp in exp1 exp2_gauss_low exp2_gauss_high; do
  python experiments/design/run_design_compare.py --exp C --dgp $dgp --n_macro 5 --n_workers 1 \
    --output_dir experiments/design/output/expC/$dgp
done

# Plots
python experiments/design/plot_design.py --exp A --output_root experiments/design/output/expA_s1small
python experiments/design/plot_design.py --exp B --output_root experiments/design/output/expB_var_epi
```
