...
Usage (from project root):
  ...
  python experiments/design/run_saturation_sweep.py \\
...
from experiments.design.run_design_compare import (
    load_dgp,
    run_one_macrorep,
    _register_dgp,
    PARAM_GRID,
...
def main():
    ...
    parser.add_argument("--dgp", type=str, required=True,
                        help="DGP name (registered in Two_stage or experiments.design._LOCAL_DGPS)")
