"""
Plot experiments/design results: Exp A (n1 vs r1) and Exp B (S^0 vs LHS).

Usage:
  python experiments/design/plot_design.py --exp A --output_root experiments/design/output/expA_s1small
  python experiments/design/plot_design.py --exp B --output_root experiments/design/output/expB_s1small
"""
