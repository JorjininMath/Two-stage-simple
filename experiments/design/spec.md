# experiments/design: Stage Design Experiment
...
See `notes/planning/archived/pre-iid-calibration-budget-design-framework.md`
for the historical pre-iid-calibration theory.
