"""
Pretrain CKME hyperparameters for experiments/design DGPs.

Usage:
  python experiments/design/pretrain_params.py --dgp exp2_gauss_low exp2_gauss_high
"""
...
def main():
    ...
    from experiments.design.run_design_compare import load_dgp
