"""
experiments/framing_validation / Gate 2: conformity-score homogeneity across x.
...
Outputs (experiments/framing_validation/output_gate2/):
...
Usage (from project root):
    ...
    python experiments/framing_validation/gate2_score_homogeneity.py --analyze_only
"""
...
OUT_DIR = Path(__file__).resolve().parent / "output_gate2"
...
def main() -> None:
    ...
    parser.add_argument(
        "--config",
        type=str,
        default="experiments/adaptive_h/config.txt",
    )
    ...
    if not args.analyze_only:
        ...
        pretrained_path = (
            _root / "experiments" / "adaptive_h" / "pretrained_params.json"
        )
