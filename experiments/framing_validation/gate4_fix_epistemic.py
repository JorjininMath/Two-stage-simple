"""
experiments/framing_validation / Gate 4: fix epistemic error via targeted Stage-2 sampling.
...
Usage from project root:
    python experiments/framing_validation/gate4_fix_epistemic.py --part all --n_macro 3
    python experiments/framing_validation/gate4_fix_epistemic.py --part all --n_macro 20 --n_workers 4
    python experiments/framing_validation/gate4_fix_epistemic.py --part a --n_stage2 20 --output_suffix n20
    python experiments/framing_validation/gate4_fix_epistemic.py --part all --analyze_only
"""
...
from experiments.framing_validation.gate3_epistemic_diagnostics import (
    invert_cdf,
    lhs_1d,
    monotone_cdf,
    raw_scores,
...
OUT_A = _HERE / "output_gate4a"
OUT_B = _HERE / "output_gate4b"
...
def main() -> None:
    ...
    if suffix:
        OUT_A = _HERE / f"output_gate4a_{suffix}"
        OUT_B = _HERE / f"output_gate4b_{suffix}"
