...
experiments/adaptive_h/plot_exp2.py: 6.5x4.5 figure, no title, no suptitle, median
curve plus 5-95% inter-macrorep band per method, nominal-coverage dashed line.

Reads:
    experiments/nongauss/output/macrorep_{k}/case_{sim}_{method}/per_point.csv

Writes:
    experiments/nongauss/output/nongauss_compare_coverage_curves_{sim}.png

Usage (from project root):
    python experiments/nongauss/plot_nongauss_A1L_compare.py
    python experiments/nongauss/plot_nongauss_A1L_compare.py --simulator nongauss_A1L --n_bins 20
"""
...
def main():
    ...
    parser.add_argument("--output_dir", type=str, default="experiments/nongauss/output")
