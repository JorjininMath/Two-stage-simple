...
Usage (from project root):
    python experiments/nongauss/analyze_adaptive_compare.py
    python experiments/nongauss/analyze_adaptive_compare.py --output_dir experiments/nongauss/output_adaptive_c2.00
    python experiments/nongauss/analyze_adaptive_compare.py --save_dir experiments/nongauss/output_adaptive_c2.00
"""
...
def main():
    ...
    out_dir = Path(args.output_dir) if args.output_dir else (
        _EXPERIMENT_DIR / "output_adaptive_c2.00")
