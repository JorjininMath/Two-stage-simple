...
The best params are saved to experiments/nongauss/pretrained_params.json and loaded
automatically by run_nongauss_compare.py.

Usage (from project root):
    python experiments/nongauss/pretrain_params.py
    python experiments/nongauss/pretrain_params.py --n_pilot 150 --r_pilot 10 --cv_folds 5
"""
...
def main():
    ...
    parser.add_argument("--output",      type=str, default=None,
                        help="Output JSON path (default: experiments/nongauss/pretrained_params.json)")
