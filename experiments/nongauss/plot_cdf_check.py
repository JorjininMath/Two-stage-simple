...
Usage (from project root):
    python experiments/nongauss/plot_cdf_check.py
    python experiments/nongauss/plot_cdf_check.py --sim nongauss_B2L --n_0 100 --r_0 5
    python experiments/nongauss/plot_cdf_check.py --save experiments/nongauss/output/cdf_check.png
"""
...
PRETRAINED = _EXPERIMENT_DIR / "pretrained_params.json"
