...
Usage (from project root):
    python experiments/nongauss/plot_nongauss.py
    python experiments/nongauss/plot_nongauss.py --output_dir experiments/nongauss/output --n_bins 25 --site_method lhs
"""
