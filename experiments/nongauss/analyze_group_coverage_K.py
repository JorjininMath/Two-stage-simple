...
Usage (from project root):
    python experiments/nongauss/analyze_group_coverage_K.py
    python experiments/nongauss/analyze_group_coverage_K.py --save experiments/nongauss/output/ablation6_K.png
"""
