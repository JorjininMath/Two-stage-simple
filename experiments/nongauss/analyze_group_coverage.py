...
Usage (from project root):
    python experiments/nongauss/analyze_group_coverage.py
    python experiments/nongauss/analyze_group_coverage.py --n_bins 10 --save experiments/nongauss/output/group_coverage.png
"""
