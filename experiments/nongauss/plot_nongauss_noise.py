...
Usage (from project root):
    python experiments/nongauss/plot_nongauss_noise.py
    python experiments/nongauss/plot_nongauss_noise.py --x_val 3.14 --save experiments/nongauss/output/nongauss_noise.png
    python experiments/nongauss/plot_nongauss_noise.py --n_samples 500000 --save experiments/nongauss/output/nongauss_noise.png
"""
