...
Usage (from project root):
  python experiments/conditional_coverage/run_consistency.py
  python experiments/conditional_coverage/run_consistency.py --h_mode adaptive --c_scale 2.0
  python experiments/conditional_coverage/run_consistency.py --simulators exp1,exp2 --n_macro 10
  python experiments/conditional_coverage/run_consistency.py --quick   # fast end-to-end test
"""
...
def _recalibrate_adaptive_cp(model, stage2, c_scale: float, alpha: float,
    ...
    # Same formula as src/CP/calibration.py.
...
def main():
    ...
    parser.add_argument("--pretrained", type=str, default=None,
                        help="Path to pretrained_params.json (default: experiments/conditional_coverage/pretrained_params.json)")
