...
Usage:
  python experiments/conditional_coverage/plot_consistency.py
  python experiments/conditional_coverage/plot_consistency.py --sims exp1
  python experiments/conditional_coverage/plot_consistency.py --output_dir experiments/conditional_coverage/output_consistency_fixed
  python experiments/conditional_coverage/plot_consistency.py --no_adaptive
"""
