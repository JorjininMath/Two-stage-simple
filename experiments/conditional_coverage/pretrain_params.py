...
One-time CV hyperparameter tuning for experiments/conditional_coverage.
...
Usage (from project root):
  python experiments/conditional_coverage/pretrain_params.py
  python experiments/conditional_coverage/pretrain_params.py --simulators exp1
  python experiments/conditional_coverage/pretrain_params.py --n_vals 64,128,512,2048 --cv_max_n 512
"""
...
def main():
    ...
    parser.add_argument("--output",    type=str, default=None,
                        help="Output JSON path (default: experiments/conditional_coverage/pretrained_params.json)")
