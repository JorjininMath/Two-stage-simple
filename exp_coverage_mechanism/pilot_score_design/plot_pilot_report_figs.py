...
BASE = "/sessions/dreamy-sharp-rubin/mnt/outputs"
rng = np.random.default_rng(0)
a = pd.read_csv(f"{BASE}/pilot_n50_b600.csv");  a["budget"] = 600
b = pd.read_csv(f"{BASE}/pilot_n50_b2000.csv"); b["budget"] = 2000
df = pd.concat([a, b])
ARMS = ["ET", "opt", "bopt"]
...
fig.tight_layout()
fig.savefig(f"{BASE}/pilot_fig1_validity_width.png", dpi=150)
...
fig.tight_layout()
fig.savefig(f"{BASE}/pilot_fig2_paired_deltas.png", dpi=150)
print("figures saved")
