...
\label{tab:exp1}
\resizebox{\linewidth}{!}{%
\input{../generated/tables/adaptive_h/exp1_fixed_reference_table.tex}
}
\end{table}
...
\label{tab:exp2}
\resizebox{\linewidth}{!}{%
\input{../generated/tables/adaptive_h/exp2_oracle_vs_fixed_table.tex}
}
\end{table}
...
\label{tab:exp3}
\resizebox{\linewidth}{!}{%
\input{../generated/tables/adaptive_h/exp3_oracle_c_sweep_table.tex}
}
\end{table}
...
defined in
\path{experiments/adaptive_h/planned_final_benchmark_spec.md}: compute the
sample standard
