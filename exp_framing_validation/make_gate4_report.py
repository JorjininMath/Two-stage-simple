...
Usage from project root:
    python exp_framing_validation/make_gate4_report.py
"""
...
OUT_PDF = _root / "output" / "pdf" / "gate4_advisor_report.pdf"
G4A_DIR = _root / "exp_framing_validation" / "output_gate4a"
G4A_N20_DIR = _root / "exp_framing_validation" / "output_gate4a_n20"
G4A_N15_DIR = _root / "exp_framing_validation" / "output_gate4a_n15"
G4B_DIR = _root / "exp_framing_validation" / "output_gate4b"
...
def build_pdf() -> Path:
    ...
    story.append(
        p(
            "Source script: exp_framing_validation/gate4_fix_epistemic.py. Report generator: exp_framing_validation/make_gate4_report.py. Metrics and figures: exp_framing_validation/output_gate4a/, output_gate4a_n20/, output_gate4a_n15/, and output_gate4b/.",
            styles,
        )
    )
