"""
exp_framing_validation / Gate 1: coverage redistribution vs noise scale s(x).

Post-hoc analysis of existing exp_adaptive_h/output_exp2 per-point outputs
...
Outputs (exp_framing_validation/output_gate1/):
...
EXP2_DIR = _root / "exp_adaptive_h" / "output_exp2"
OUT_DIR = _root / "exp_framing_validation" / "output_gate1"
